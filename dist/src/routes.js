...
const WeeklyRuleController_1 = __importDefault(require("./controllers/WeeklyRuleController"));
...
router.post('/regra/semanalmente', WeeklyRuleController_1.default.store);
router.delete('/regra/semanalmente', WeeklyRuleController_1.default.delete);
